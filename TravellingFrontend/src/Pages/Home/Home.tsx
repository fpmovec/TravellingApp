      ...
      <div className="travelling-selector">
        ...
        <div className="travelling-selector-block">
          <div className="travelling-selector-content">
            ...
            <Time />
            <SelectorBox label="Country" value={country} source={countries} handleValue={setCountry}/>
            <SelectorBox label="Transport" value={transport} source={transportTypes} handleValue={setTransport}/>
            <button className="search"><i className="fa fa-search fa-lg" aria-hidden={true}></i></button>
          </div>
        </div>
      </div>
